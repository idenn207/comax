...
export function SiteHeader() {
  return (
    <header className="sticky top-0 z-30 border-b border-border bg-[oklch(98.5%_0.002_260/0.8)] backdrop-blur-md [[data-theme='dark']_&]:bg-[oklch(15%_0.006_260/0.8)]">
      <div className="mx-auto flex h-[var(--header-height)] max-w-content items-center gap-6 px-4 sm:px-6">
        ...
        <nav className="hidden flex-1 items-center gap-1 md:flex" aria-label="주요">
          {mainNav.map((item) =>
            item.external ? (
              <a
                key={item.href}
